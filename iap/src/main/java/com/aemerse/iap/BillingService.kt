...
class BillingService(
    ...
    private var selectedOfferIndex = 0
    ...
    private fun launchBillingFlow(activity: Activity, sku: String, type: String) {
        sku.toProductDetails(type) { productDetails ->
            if (productDetails != null) {
                selectedOfferIndex = productDetails.subscriptionOfferDetails!!.size - 1
                val offerToken =
                    productDetails.subscriptionOfferDetails!![selectedOfferIndex].offerToken
                log("subscriptionOfferDetails=$offerToken")
            ...
            when {
                billingResult.isOk() -> {
                    ...
                    val productDetails: ProductDetails? =
                        productDetailsList.find {
                            it.productId == this
                            //selectedOfferIndex = it.
                        }
